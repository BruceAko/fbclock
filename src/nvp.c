...
/*==========================================================================
  nvp_create
*==========================================================================*/
NameValuePair* nvp_create(const char* name, void* value, ValueFreeFn valueFreeFn) {
  LOG_IN
...
/*==========================================================================
  nvp_get_name
*==========================================================================*/
const char* nvp_get_name(const NameValuePair* self) { return self->name; }

/*==========================================================================
  nvp_get_value
*==========================================================================*/
const void* nvp_get_value(const NameValuePair* self) { return self->value; }
